...
void CLighting::render()
{
	...
	glPushMatrix();
	{
		...
		// 부분 조명
		// 오른쪽 부분
		flash(110, 10, 110, GL_LIGHT1, isLightNum1, 1, 0, 0, 1);
		flash(110, 10, -110, GL_LIGHT2, isLightNum2, 0, 1, 0, 1);
		// 왼쪽 부분
		flash(-110, 10, 110, GL_LIGHT3, isLightNum3, 0, 0, 1, 1);
		flash(-110, 10, -110, GL_LIGHT4, isLightNum4);
	}
	glPopMatrix();
...
void CLighting::flash(float x, float y, float z, float light, bool isLight, float r, float g, float b, float a)
{
